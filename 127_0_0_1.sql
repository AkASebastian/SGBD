...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2023 at 10:11 PM
...
--
-- Database: `c0d_companii_aeriene`
--
CREATE DATABASE IF NOT EXISTS `c0d_companii_aeriene` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `c0d_companii_aeriene`;
--
-- Database: `cod_companii_aeriene`
--
CREATE DATABASE IF NOT EXISTS `cod_companii_aeriene` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cod_companii_aeriene`;
...
CREATE TABLE `localitati` (
  `cod_localitate` int(11) NOT NULL,
  `nume_localitate` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `bilete`
  ADD CONSTRAINT `bilete_ibfk_1` FOREIGN KEY (`cod_client`) REFERENCES `clienti` (`cod_client`),
...
-- Database: `contactme`
--
CREATE DATABASE IF NOT EXISTS `contactme` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `contactme`;
...
(1, 'Holtea Sebastian', 'holteasebastian@yahoo.com', 'Test\r\n'),
(2, 'asd', 'asd@gmail.com', 'sd'),
(3, 'Holtea sebastian', 'holteasebastian@yahoo.com', 're'),
(4, 'Holtea sebastian', 'holteasebastian@yahoo.com', 'asd'),
(5, 'Holtea sebastian', 'holteasebastian@yahoo.com', 'des'),
(6, 'ioneel', 'holteasebastian@yahoo.com', 'asdwer');
...
('root', '[{\"db\":\"contactme\",\"table\":\"contactinfo\"}]');
...
('root', '2023-02-27 21:06:20', '{\"Console\\/Mode\":\"collapse\"}');
